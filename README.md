...
- You must have completed the [NFT-Collection tutorial](https://github.com/pareshkapdiya/NFT-Collection)
...
- In your public folder, download the following image (https://github.com/pareshkapdiya/NFT-Collection/tree/main/my-app/public/cryptodevs/0.svg). Make sure that the name of the downloaded image is `0.svg`
